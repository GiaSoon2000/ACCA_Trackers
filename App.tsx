...
export default function App() {
  ...
  // Guard: don't save to cloud until the initial load has completed.
  ...
  useEffect(() => {
    ...
    // This prevents the race condition where an empty chapters[] state
    // is saved before Firestore data has been fetched and applied.
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        {chTotal > 0 && (
                          <button
                            ...
                            title={allDone ? "Uncheck all subchapters" : "Check all subchapters"}
